...
(function () {
  ...
  var ACTIVE   = 'text-primary font-bold border-b-2 border-primary pb-1 neon-text-cyan';
  var INACTIVE = 'text-primary opacity-60 hover:opacity-100 transition-opacity duration-150 cursor-pointer active:scale-95';
  ...
  var html = [
    ...
    '    <span class="font-display-lg text-headline-md text-primary tracking-tighter neon-text-cyan animate-glitch hover-glitch">DS_OPS // HUB</span>',
